...
public class CourseService {
    ...
    // course controller @Get (get all courses)
    public List<Course> getAllCourse() {
      return courseRepository.findAll();
    }

    // course controller @Get (get courses by id) 
    ...
    // Post courses and chapter but as an object, cannot add multiple chapter inside an course. under modification POST
    public Course saveCourse(Course newCourse) {
      System.out.println(newCourse.getCourse_id());
      System.out.println(newCourse.getCourse_title());
      System.out.println(newCourse.getCourse_description());
    ...
    //delete course by id (working using postman) DELETE
    ...
    //update course datails by id PUT
    ...
    // }
      ...
      //Get list of chapters inside courses
