...
const AccDetails = () => {
  return (
    <>
      ...
      <div className="relative w-[90%] flex flex-col justify-end items-start h-full  lg:w-[700px] lg:h-[350px] xl:w-[979px] xl:h-[512px] bg-[#126912] lg:rounded-md shadow-md ">
