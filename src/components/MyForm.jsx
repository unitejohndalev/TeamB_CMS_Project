...
function MyForm() {
  ...
  return (
    <div className="relative shadow-md h-full w-[90vw] mt-[250px] m-auto
    lg:max-w-[740px]
    ">
      <div className="flex flex-col justify-center items-center">
        <p className="text-[#4D4141] font-bold text-[2rem]">
        ...
        <form
          ...
          className="flex flex-col w-[90%] min-h-[40vh] mt-5 justify-between lg:flex lg:items-center">
